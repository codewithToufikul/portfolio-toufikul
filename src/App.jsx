      ...
      <div className="">
            ...
            <div className="flex md:flex-row gap-4 flex-col justify-between px-10 items-center max-w-[1440px] mx-auto">
              <div className="space-y-6">
                ...
                <a
                  href="/resume.pdf"
                  download
                  className="cursor-pointer text-xl font-semibold btn bg-orange-700 border-none text-white"
                >
                  <span>RESUME</span>
                  <span>
                    <FaDownload />
              ...
              <div>
                <div className="card bg-gradient-to-r from-cyan-500 to-blue-500 lg:w-96 shadow-2xl shadow-blue-500/50">
          ...
          <div id="about" className="max-w-[1340px] mx-auto">
            ...
            <div className="flex md:flex-row gap-4 flex-col-reverse items-center justify-between md:mt-16 mt-8  lg:mt-24">
              ...
              <div className="space-y-4 px-2  md:w-1/2">
                <h2 className="text-4xl md:block hidden text-green-500">WHO I AM?</h2>
        ...
        <div className=" max-w-[1340px] mx-auto">
          ...
          <div className=" flex flex-wrap gap-5 justify-center mt-12">
            <div className="card bg-slate-800 lg:w-52 shadow-xl">
            ...
            <div className="card bg-slate-800 lg:w-52 shadow-xl">
              <div className="card-body px-10 p-8 flex flex-col justify-center items-center pb-4">
                <img className=" w-[70px]" src={tail} alt="" />
                <h2 className=" text-slate-200 text-xl font-semibold text-center ">
                  Tailwind CSS
                </h2>
              </div>
            ...
            <div className="card bg-slate-800 lg:w-52 shadow-xl">
              <div className="card-body px-10 p-8 flex flex-col justify-center items-center pb-4">
                <img className=" w-[70px]" src={boot} alt="" />
                <h2 className=" text-slate-200 text-xl font-semibold text-center ">
                  Bootstrap
                </h2>
              </div>
          ...
          <div>
            ...
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                    {['About', 'Contact', 'Skill', 'Resume', 'Social', 'Terms'].map((item) => (
